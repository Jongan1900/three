...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      children:[
        {path:'friendsg', name: 'pyq', component:()=>import('./components/Discover/FriendsList.vue')},
        {path:'gc', name: 'gc', component:()=>import('./components/Discover/PlaZa.vue'),
        children:[
          {path:'',name: 'dynamic', component:()=>import('./components/Discover/Dynamic/Dynamic.vue')},
          {path:'dynamic',name: 'dynamic', component:()=>import('./components/Discover/Dynamic/Dynamic.vue')},
          {path:'theme',name: 'theme', component:()=>import('./components/Discover/Dynamic/Theme.vue')}
        ]
      }
      ]
    },
